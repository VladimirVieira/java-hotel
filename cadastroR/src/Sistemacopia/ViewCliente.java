...
/**
 * 
 * Classe para objetos do tipo ViewCliente, onde serão contidos, valores e métodos para o mesmo.
...
public class ViewCliente extends JInternalFrame {
	...
	/** Método principal onde inicializa o cadastro de clientes
