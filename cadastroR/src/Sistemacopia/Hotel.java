...
/**
 * 
 * Classe para objetos do tipo Hotel, onde serão contidos, valores e métodos para o mesmo.
...
public class Hotel extends JFrame {
	...
	/** Método principal onde inicializa o registro de servicos
	...
	public Hotel() {
		...
		mntmCadastrarC.addActionListener(new ActionListener() {
			...
			/** Método usado para cadastrar um cliente
		     * 
		...
		mntmDemandarSer.addActionListener(new ActionListener() {
			...
			/** Método usado para registrar um serviço
		     * 
		     * @param e um objeto do tipo ActionEvent
		     *
		     */
		...
		mntmConfirmar.addActionListener(new ActionListener() {
			...
			/** Método usado para sair do sistema
		     * 
		     * @param e um objeto do tipo ActionEvent
		     *
		     */
